...
require_once('Connections/cone.php');
	...
	mysql_select_db($database_cone, $cone);
	$query_rs_pro = "SELECT * FROM volvo_productos WHERE nombre LIKE '%$busca%' OR descripcion LIKE '%$busca%' OR item LIKE '%$busca%' OR modelos LIKE '%$busca%' AND habilitado = '1' ";
...
?>QUE BUSCO: <?php echo $busca;?></span>
	...
	$query_rs_cuenta = "SELECT * FROM volvo_productos WHERE categoria = '$idcate' AND subcategoria = '$subcategoria' AND habilitado = '1' AND (nombre LIKE '%$busca%' OR descripcion LIKE '%$busca%' OR item LIKE '%$busca%' OR modelos LIKE '%$busca%')";
	...
	mysql_select_db($database_cone, $cone);
	$query_rs_cuenta_modelo_2 = "SELECT * FROM volvo_productos WHERE habilitado = '1' AND categoria = '$idcate' AND subcategoria = '$subcategoria' AND (nombre LIKE '%$busca%' OR descripcion LIKE '%$busca%' OR item LIKE '%$busca%') AND modelos LIKE '%$mmodelo%' ";
