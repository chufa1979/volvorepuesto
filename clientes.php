...
if ((isset($_GET["eliminalinea"])) || (isset($_GET["eliminalinea_x"]))){
  $v = $_GET['vid'];
  $deleteSQL = "DELETE FROM volvo_clientes WHERE id='$v'";
  ...
  $Result1 = mysql_query($deleteSQL, $cone) or die(mysql_error());
   ...
   mysql_select_db($database_cone, $cone);
   $query_rs1 = "SELECT * FROM volvo_clientes ORDER BY apellido DESC";
        ...
        <td class="content"><div class="listado-top">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="230" align="left">E-mail</td>
              <td width="150" align="left">Tel&eacute;fono</td>
              <td width="70" align="center">Pedidos</td>
              <td width="70" align="center">Reclamos</td>
              <td align="center">&nbsp;</td>
...
$cadenars1  = $myrow['fecha'];
    ...
    echo $dia.".".$mes.".".$anio;               
			  ?></td>
              <td width="200" align="left" class="txt_bold"><?php echo $myrow['nombre']; ?> <?php echo $myrow['apellido']; ?></td>
              <td width="230" align="left"><a href="mailto:<?php echo $myrow['email']; ?>"><?php echo $myrow['email']; ?></a></td>
              <td width="150" align="left"><?php echo $myrow['telefono']; ?></td>
              <td width="70" align="center"><a class="tooltips" href="pedidos.php?iduser=<?php echo $myrow['id']; ?>">Ver<span>Ver Pedidos</span></a></td>
              <td width="70" align="center"><a class="tooltips" href="reclamos.php?iduser=<?php echo $myrow['id']; ?>">Ver<span>Ver Reclamos</span></a></td>
              <td align="center">&nbsp;</td>
              <td width="70" align="left"><a class="tooltips" href="clientes_ver.php?vid=<?php echo $myrow['id']; ?>"><img src="img/icono_ver.gif" alt="VER" width="60" height="30" border="0" /><span>Ver detalle</span></a></td>
              <td width="60" align="right"><div class="listing" style="display:none" id="open_ajax_dialog_codediv1">
                  <div id="ajax_dialog<?php echo $myrow['id']; ?>">Dialog.alert({url: "clientes_eliminar.php?vid=<?php echo $myrow['id']; ?>", options: {method: 'get'}},  
