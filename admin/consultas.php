...
$_SESSION['pagina'] = 'consultas.php';


if ((isset($_GET["eliminalinea"])) || (isset($_GET["eliminalinea_x"]))){
  $v = $_GET['vid'];
  $deleteSQL = "DELETE FROM volvo_consulta WHERE id='$v'";
  ...
  $Result1 = mysql_query($deleteSQL, $cone) or die(mysql_error());
   ...
   mysql_select_db($database_cone, $cone);
   $query_rs1 = "SELECT * FROM volvo_consulta ORDER BY id DESC";
...
<div id="rutas">
  <div class="ruta">CONSULTAS DE PRODUCTOS</div>
</div>
<div class="main">
  <div id="contenido">
        ...
        <td class="content"><div class="listado-top">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <td width="100" align="left">Fecha</td>
              ...
              <td width="250" align="left">Email</td>
              <td align="left">Repuesto</td>
...
$cadenars1  = $myrow['fecha'];
    ...
    echo $dia.".".$mes.".".$anio;               
              ...
              <td width="250" align="left"><a href="mailto:<?php echo $myrow['email']; ?>"><?php echo $myrow['email']; ?></a></td>
              <td align="left"><?php echo $myrow['producto']; ?></td>                
              <td width="70" align="left"><a class="tooltips" href="consultas_detalle.php?vid=<?php echo $myrow['id']; ?>"><img src="img/icono_ver.gif" alt="VER" width="60" height="30" border="0" /><span>Ver detalle</span></a></td>
              <td width="60" align="right"><div class="listing" style="display:none" id="open_ajax_dialog_codediv1">
                <div id="ajax_dialog<?php echo $myrow['id']; ?>">Dialog.alert({url: "consultas_eliminar.php?vid=<?php echo $myrow['id']; ?>", options: {method: 'get'}},  
