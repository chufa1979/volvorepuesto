...
if ((isset($_GET["buscar"])) || (isset($_GET["buscar_x"]))){	
   ...
   mysql_select_db($database_cone, $cone);
   $query_rs1 = "SELECT * FROM volvo_reclamos WHERE 1=1 $bus $buscar $c ORDER BY id DESC";
   $rs1 = mysql_query($query_rs1, $cone) or die(mysql_error());
...
$cadenars1  = $myrow['fecha'];
    ...
    echo $dia.".".$mes.".".$anio;               
              ...
              <td width="70" align="left"><a class="tooltips" href="reclamos_detalle.php?vid=<?php echo $myrow['id_pedido']; ?>&reclamo=<?php echo $myrow['id']; ?>"><img src="img/icono_ver.gif" alt="VER" width="60" height="30" border="0" /><span>Ver detalle</span></a></td>
              <td width="60" align="right"><div class="listing" style="display:none" id="open_ajax_dialog_codediv1">
                <div id="ajax_dialog<?php echo $myrow['id']; ?>">Dialog.alert({url: "reclamos_eliminar.php?vid=<?php echo $myrow['id']; ?>", options: {method: 'get'}},  
