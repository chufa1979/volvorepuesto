...
if ((isset($_GET["eliminalinea"])) || (isset($_GET["eliminalinea_x"]))){
	...
	$query_rsc = "SELECT * FROM volvo_slider_abajo WHERE id = '$v'";
  ...
  $deleteSQL = "DELETE FROM volvo_slider_abajo WHERE id='$v'";
  mysql_select_db($database_cone, $cone);
...
if ((isset($_POST["editar"])) || (isset($_POST["editar_x"]))){
	...
	$orden_e = $_POST['orden_e'];
      $updateSQL = "UPDATE volvo_slider_abajo SET orden='$orden_e',alt='$altimg',link='$link',youtube='$youtube' WHERE id='$id'";
	  ///echo $updateSQL;
	  mysql_select_db($database_cone, $cone);
...
if ((isset($_POST["agregar"])) || (isset($_POST["agregar_x"]))){
	...
	if ($_FILES['fc01']['name']<>"") {
 	/** CREACION DE CARPETAS **/
	  ...
	  $link = $_POST['link'];
      $updateSQL = "INSERT INTO volvo_slider_abajo (imagen,alt,link,youtube,orden) VALUES
	...
	mysql_select_db($database_cone, $cone);
	$query_rs = "SELECT * FROM volvo_slider_abajo";
...
<div id="rutas">
  <div class="ruta">Banner inferior</div>
</div>
<div class="main">
  <div id="contenido">
