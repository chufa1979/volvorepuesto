...
<div class="sections_login">
  <form id="form3" name="form3" method="post" action="olvido_ok.php">
  <div class="titulo_seccion">OLVIDO DE CONTRASE&Ntilde;A</div>
	<div class="login_columnas">
  <h3>RECUPERAR CLAVE</h3>
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="2" align="left">Para recuperar tu clave ingres&aacute; a continuaci&oacute;n el e-mail con el que est&aacute;s registrado.<br />
        Recibir&aacute;s un correo en tu casilla con tu clave.<br />
        <br /></td>
      </tr>
    <tr>
      <td width="100" align="right">E-mail*&nbsp;&nbsp;</td>
      <td align="left"><input name="emaile" type="text" class="login_campo" id="emaile" required="required" /></td>
    </tr>
    <tr>
      <td align="right">&nbsp;</td>
      <td align="left">&nbsp;</td>
    ...
    <tr>
      <td align="right">&nbsp;</td>
      <td align="left"><input name="button" type="submit" class="enviar" id="button" value="ENVIAR" /></td>
    </tr>
  </table>
    </div>
  </form>
