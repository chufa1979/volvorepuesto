...
<?php require_once('../Connections/cone.php');  
   ...
   if ($_SESSION['bandero']==1) { 
   		$query_rs1 = "SELECT * FROM volvo_pedido WHERE id = '$vid' AND (id_concesionario='15' OR id_concesionario='16' OR id_concesionario='17' OR id_concesionario='18')";
   } else {
