...
function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
  ...
  return $theValue;
   ...
   if ($_SESSION['bandero']==1) { 
   	   $query_rs1 = "SELECT * FROM volvo_pedido WHERE id = '$vid' AND (idcon='15' OT idcon='16' OR idcon='17' OR idcon='18')";
   } else {
	   $query_rs1 = "SELECT * FROM volvo_pedido WHERE id = '$vid' AND idcon='$idp'";
   }
...
<div id="rutas">
  <div class="ruta">PEDIDOS&nbsp;&nbsp;&nbsp;&raquo;&nbsp;&nbsp; detalle</div>
</div>
<div class="main">
  <div id="contenido">
...
$cadenars1  = $row_rs1['fecha'];
    ...
    echo $dia.".".$mes.".".$anio;               
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="150"><div class="listadodetalle"> N&deg; Orden</div></td>
              <td><div class="listado">
                <?php
			  $nroorden = str_pad($row_rs1['id'], 5, "0", STR_PAD_LEFT);
			  
			   echo $row_rs1['codigo']; ?>
                -<?php echo $nroorden; ?></div></td>
            </tr>
        </table>
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td align="left"><div class="listado"><?php print $row_rspro['item']; ?> - <?php print $row_rspro['nombre']; ?></div></td>
              <td width="120" align="left"><div class="listado"><?php if ($row_rspro['moneda']=='') { echo '$'; } else { echo $row_rspro['moneda'];} ?> <?php print $row_rspro['precio']; ?></div></td>
              <td width="120" align="left"><div class="listado"><?php if ($row_rspro['moneda']=='') { echo '$'; } else { echo $row_rspro['moneda'];} ?> <?php echo ($row_rspro['cantidad']*$row_rspro['precio']); ?></div></td>
            </tr>
            ...
            <tr bgcolor="#D2E4EE">
              ...
              <td width="120" height="30" align="left" class="txt_azul"><strong><?php if ($row_rs1['moneda']=='') { echo '$'; } else { echo $row_rs1['moneda'];} ?> <?php echo $row_rs1['total']; ?></strong></td>
            </tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0" class="recuadro">
            ...
            <td class="content"><?php echo $row_rs1['chasis']; ?></td>
                ...
                <br />
          <div class="subtitulo_azul">Comentario</div>
          <table border="0" cellpadding="0" cellspacing="0" class="recuadro">
            <tr>
            <td class="content"><?php echo $row_rs1['comentarios']; ?></td>
          </tr>
      </table>
        <br />
          ...
          <tr>
            <td class="content"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="250"><div class="listado"><?php echo $row_rs4['nombre']; ?> <?php echo $row_rs4['apellido']; ?></div></td>
                <td width="100"><div class="listadodetalle">E-mail</div></td>
                <td><div class="listado"><a href="mailto:<?php echo $row_rs4['email']; ?>"><?php echo $row_rs4['email']; ?></a></div></td>
                </tr>
            </table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="150"><div class="listadodetalle">Tel&eacute;fono</div></td>
                  <td width="250"><div class="listado"><?php echo $row_rs4['telefono']; ?></div></td>
                  <td width="100"><div class="listadodetalle">DNI</div></td>
                  <td><div class="listado"><?php echo $row_rs4['dni']; ?></div></td>
                  </tr>
            </table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="150"><div class="listadodetalle">Calle</div></td>
                  <td width="250"><div class="listado"><?php echo $row_rs4['calle']; ?></div></td>
                  <td width="100"><div class="listadodetalle">Nro</div></td>
                  <td><div class="listado"><?php echo $row_rs4['num']; ?></div></td>
                  </tr>
            </table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="150"><div class="listadodetalle">Localidad</div></td>
                  <td width="250"><div class="listado"><?php echo $row_rs4['localidad']; ?></div></td>
                  <td width="100"><div class="listadodetalle">Piso</div></td>
                  <td width="100"><div class="listado"><?php echo $row_rs4['piso']; ?></div></td>
                  <td width="100"><div class="listadodetalle">Depto</div></td>
                  <td><div class="listado"><?php echo $row_rs4['depto']; ?></div></td>
                </tr>
              </table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="150"><div class="listadodetalle">Pa&iacute;s</div></td>
                  <td width="250"><div class="listado"><?php echo $row_rs4['pais']; ?></div></td>
                  <td width="100"><div class="listadodetalle">Provincia</div></td>
                  <td><div class="listado"><?php echo $row_rs4['provincia']; ?></div></td>
                  </tr>
              </table>
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="150"><div class="listadodetalle">CUIT/CUIL</div></td>
                  <td width="250"><div class="listado"><?php echo $row_rs4['cuitnro']; ?></div></td>
                  <td width="100"><div class="listadodetalle">Cond. IVA</div></td>
                  <td><div class="listado"><?php echo $row_rs4['iva']; ?></div></td>
                  </tr>
            </table></td>
          </tr>
        </table></td>
