...
if ((isset($_GET["buscar"])) || (isset($_GET["buscar_x"]))){	
   ...
   if ($_SESSION['bandero']==1) { 
   	  $query_rs1 = "SELECT * FROM volvo_pedido WHERE (idcon='15' OT idcon='16' OR idcon='17' OR idcon='18') $bus $c ORDER BY id DESC";
   } else {
...
<?php } while($row_rs2 = mysql_fetch_assoc($rs2));
				...
				<td width="190" align="right"><a href="pedidos_excel.php"><img src="../admin/img/excel.gif" width="180" height="35" /></a></td>
...
$cadenars1  = $myrow['fecha'];
    ...
    echo $dia.".".$mes.".".$anio;               
              ...
              <td width="70" align="left"><a class="tooltips" href="pedidos_detalle.php?vid=<?php echo $myrow['id']; ?>"><img src="../admin/img/icono_ver.gif" alt="VER" width="60" height="30" border="0" /><span>Ver detalle</span></a></td>
